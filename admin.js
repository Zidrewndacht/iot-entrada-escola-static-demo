...
function animateModalSmallOpen() {    //modalWrapperSmall é animado no instante de atualização do cursor em vez de aqui.
    ...
    // modalSmall.style.transform = "scale3d(1,1,1)";
    modalSmall.style.transform = "scale3d(1,1,1) rotate3d(0, 0, 0, 0deg)";
...
function animateModalSmallClose() {
    ...
    // modalSmall.style.willChange = 'opacity, transform, z-index';
    modalWrapperSmall.style.transition = "0.6s all ease-out";
    modalSmall.style.transition = "0.6s all ease-out";
    modalWrapperSmall.style.opacity = "0";
    modalSmall.style.opacity = "0";
    // modalSmall.style.transform = "scale(0.9)";
    // modalSmall.style.transform = "scale3d(0.9,0.9,0.9)";
    modalSmall.style.transform = "scale3d(0.8,0.8,0.8) rotate3d(1, 0, 0, 24deg)";
    ...
    setTimeout(() => {
        ...
        modalSmall.style.transform = "scale3d(0.9,0.9,0.9) rotate3d(-1, 0, 0, 12deg)"; //prepara para abrir novamente no futuro
    }, 660);  // Change '500' to your desired delay in milliseconds

    return new Promise(resolve => {     //promessa necessária para timing de fechamento e reabertura de modal
        setTimeout(resolve, 660);       //resolve a promessa após animação
    });
}
...
function animateModalLargeOpen() {
    ...
    modalLarge.style.transform = "scale(1)";    //3D parece não funcionar neste modal?
